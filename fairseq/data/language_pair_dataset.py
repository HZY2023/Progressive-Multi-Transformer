...
def collate(
    ...
    src_img_features = torch.cat([s['src_img_features'] for s in samples], dim=0)
    # multimodel_graph = multigraph_merge('bpe_txt_relations', 'img_txt_relations', src_lengths)
    # src_img_features = merge1('src_img_features')
    # src_img_features = torch.cat('src_img_features',dim=0)
...
class LanguagePairDataset(FairseqDataset):
    ...
    def __getitem__(self, index):
        ...
        example = {
            ...
            'source': src_item,
            'target': tgt_item,
            'src_img_features': src_img_features_item.unsqueeze(0),
